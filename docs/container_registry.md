...
# Prerequisites
  ...
  - [Docker GitLab](https://github.com/docker-gitlab) >= 8.8.5-1
...
For more info look at [Available Configuration Parameters](https://github.com/docker-gitlab#available-configuration-parameters).
