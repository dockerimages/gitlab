...
- Add docs how to reuse ssh port [#1731](https://github.com/docker-gitlab/pull/1731)
...
- Fix backup config stripping for when AWS & GCS backups are disabled [#1725](https://github.com/docker-gitlab/pull/1725)
- Correct Backup Date format for selective backups [#1699](https://github.com/docker-gitlab/pull/1699)
...
**10.8.3-1**
- Fix boot loops that were introduced during [#1621](https://github.com/docker-gitlab/pull/1621) and will be fixed with [#1628](https://github.com/docker-gitlab/pull/1628)


**10.8.3**
- gitlab: upgrade CE to v10.8.3
- Fix potential boot problems on clean setups [#1621](https://github.com/docker-gitlab/pull/1621)
...
- Add support for swarm mode with docker-configs and docker secrets ([#1540](https://github.com/docker-gitlab/pull/1540))
...
- ADDED `AWS_BACKUP_ENCRYPTION` [1449](https://github.com/docker-gitlab/pull/1449/)
- ADDED `AWS_BACKUP_STORAGE_CLASS` [1449](https://github.com/docker-gitlab/pull/1449/)
- FIXED `AWS_BACKUP_MULTIPART_CHUNK_SIZE` [1449](https://github.com/docker-gitlab/pull/1449/)
- Apply PaX mark to ruby [1458](https://github.com/docker-gitlab/pull/1458)
...
- Added support for nginx_real_ip module ([#1137](https://github.com/docker-gitlab/pull/1137))
- Added more security for regenarting certs ([#1288](https://github.com/docker-gitlab/pull/1288))
...
**8.0.4-1**
- update baseimage to `ubuntu:14.04.20151011`
...
- rebase image on debian:jessie.20140918 base image
...
- update to the ubuntu:14.04.20140818 baseimage
...
- update to the ubuntu:14.04.20140812 baseimage
...
- update to the ubuntu:14.04.20140628 baseimage
...
- use ubuntu:14.04.20140508 base image, the trusted build of ubuntu:14.04.20140505 seems to be broken
- use ubuntu:14.04.20140505 base image
